...
function generateTeaserStar(starType) {
	...
	var el = createTeaserElementProductTile('span', 'TTteaser__star', null);
...
function getAdjustedRating(rating) {
	var floorValue = Math.floor(parseFloat(rating));
	var rounded = Math.round(parseFloat(rating) * 100) / 100;
...
function generateTeaserStars(rating) {
    var el = createTeaserElementProductTile('div', 'TTteaser__rating', null);
