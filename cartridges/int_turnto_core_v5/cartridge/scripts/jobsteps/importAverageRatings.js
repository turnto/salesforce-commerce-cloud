                        ...
                        if (element === XMLStreamConstants.START_ELEMENT) {
                            ...
                            if (localElementName === 'product') {
                                try {
                                    ...
                                    if (product != null) {
                                        Logger.info('INFO product is found, product id=' + product.ID);
                                        ...
                                        Logger.error('ERROR product is NULL, product id=' + productNode.attribute('sku'));
                                    }
                                } catch (e) {
                                    error = true;
                                    Logger.error('Product SKU failed to update due to {0}', e.message);
                                }
                            }
                        }
                    }
